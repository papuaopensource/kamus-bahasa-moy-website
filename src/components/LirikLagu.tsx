          ...
          {sortedSongs.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {sortedSongs.map((song) => (
                <Card key={song.id} className="flex flex-col shadow-none hover:shadow transition-shadow">
                        ...
                        <div className="mt-4">
                          ...
                          <Tabs defaultValue="lyrics" className="w-full">
                            <TabsList className="grid w-full grid-cols-2">
                              ...
                              <TabsTrigger value="translation" disabled={!song.translation}>
                                Terjemahan
                              </TabsTrigger>
                            </TabsList>
                            ...
                            <TabsContent value="translation" className="mt-4">
                              {song.translation ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-12 text-center">
                                  ...
                                  <h3 className="text-lg font-medium">Terjemahan tidak tersedia</h3>
                                  <p className="text-muted-foreground">Terjemahan untuk lagu ini belum tersedia</p>
                                </div>
                              )}
                            </TabsContent>
                          </Tabs>
